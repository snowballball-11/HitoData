  ...
  route: {
    routes: [
      ...
      },
      {
        ...
        name: '版本',
        icon: <History theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
        ...
        routes: [
          ...
          },
          {
            ...
            name: '我的工单',
            icon: <TransactionOrder theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
          },
          {
            path: '/design/table/version/approval',
            name: '我的审批',
            icon: <Audit theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
          },
        ],
      },
      {
        name: '导入',
        icon: <Warehousing theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
        ...
        routes: [
          {
            ...
            name: '数据源逆向解析',
            icon: <DataDisplay theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
            access: 'canErdConnectorDbreverseparse',
          },
          {
            path: '/design/table/import/pdman',
            name: '解析PdMan文件',
            icon: <FileJpg theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
            access: 'canErdTableImportPdman',
          },
          {
            path: '/design/table/import/erd',
            name: '解析ERD文件',
            icon: <FileLock theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      ...
      {
        name: '导出',
        icon: <Outbound theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
        ...
        routes: [
          {
            ...
            name: '普通导出',
            icon: <Export theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
            access: 'canErdTableExportCommon',
          },
          {
            path: '/design/table/export/more',
            name: '高级导出',
            icon: <DatabaseDownload theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      ...
      {
        name: '设置',
        icon: <SettingTwo theme="filled" size="15" fill={colorPrimary} strokeWidth={2}/>,
        ...
        routes: [
          {
            ...
            name: '数据源设置',
            icon: <DatabaseConfig theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
            access: 'canErdTableSettingDb',
          },
          {
            path: '/design/table/setting/defaultField',
            name: '默认字段设置',
            icon: <Column theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
            access: 'canErdTableSettingDefaultfield',
          },
          {
            path: '/design/table/setting/default',
            name: '系统默认项设置',
            icon: <SettingConfig theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
