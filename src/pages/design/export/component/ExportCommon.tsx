  ...
  const data = [
    {
      ...
      avatar: <FileLock theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      content: (
      ...
      avatar: <HtmlFive theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      content: (
      ...
      avatar: <FileWord theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      content: (
      ...
      avatar: <FileDisplay theme="filled" size="18" fill={colorPrimary} strokeWidth={2}/>,
      content: (
